...
define(
  ...
  function() {
    return {
      ...
      'cloud.get_aws_db_versions': '/cloud/get_aws_db_versions/',

      'cloud.verify_credentials': '/cloud/verify_credentials/',

      'cloud.get_aws_db_instances': '/cloud/get_aws_db_instances/',

      'cloud.update_cloud_server': '/cloud/update_cloud_server',

      'cloud.update_cloud_process': '/cloud/update_cloud_process/<sid>',

      'cloud.get_aws_regions': '/cloud/get_aws_regions/',
